  ...
  return (
    <>
      <div className='text-center max-w-sm sm:max-w-lg space-y-4'>
        <h1
          className='my-8 bg-gradient-to-br from-white via-white to-[#532a01] bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl'>
      ...
      <div className='relative my-10'>
        ...
        >
          ...
          <p
            className='font-mono text-white absolute -bottom-10 group-hover:bottom-5 transition-all ease-in-out duration-300'>
            1:03
          </p>
        </button>
        <video
