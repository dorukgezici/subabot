<h1>Privacy Policy for Subabot</h1>

<p>
	At Subabot, accessible from https://subabot.gezici.me, one of our main priorities is the privacy
	of our visitors. This Privacy Policy document contains types of information that is collected and
	recorded by Subabot and how we use it.
</p>
...
<p>
	...
	with regards to the information that they shared and/or collect in Subabot. This policy is not
...
<p>
	Subabot follows a standard procedure of using log files. These files log visitors when they visit
...
<p>
	...
	that are used in their respective advertisements and links that appear on Subabot, which are sent
...
<p>
	Note that Subabot has no access to or control over these cookies that are used by third-party
	advertisers.
</p>
...
<p>
	Subabot's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
...
<p>
	Subabot does not knowingly collect any Personal Identifiable Information from children under the
